...
- source run: PR #212 `Policy eval latency` failure log
...
| Veto    | 100-rule local eval from merged packs |     50,000 | 0.027291ms | 0.037470ms | 0.057136ms |         0.5ms | GitHub Actions PR-mode, `benchmark/baselines/hundred-rule-local.json`         |
