...
See [veto-platform/.github/LINEAR_SYNC.md](https://github.com/PlawIO/veto-platform/blob/main/.github/LINEAR_SYNC.md) for the full setup (user map, secrets, anti-conflict details).
